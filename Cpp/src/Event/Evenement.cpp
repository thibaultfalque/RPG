...
Evenement::Evenement(){
    ...
    {
        cerr << "Erreur de chargement du fichier de configuration des touches." << endl;
        cout << "La configuration des touches a été réinitialisée." << endl;
...
Keyboard::Key Evenement::getEventKey(string str){
    ...
    {
        cerr << (L"L'évènement demandé \"" + str + L"\" n'a pas été trouvé dans le gestionnaire d'évènement", __FILE__, __LINE__) << endl;;
